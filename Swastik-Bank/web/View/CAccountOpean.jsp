        ...
        <head>
            ...
            <script>
                ...
                function StateValidate() {
                    ...
                    if (name.value.trim() == "") {
                        ...
                        if (reg.test(name.value)) {
                            ...
                            udaydisplay.innerHTML = "Only letters are allowed in State Name";
                            udaydisplay.style.color = "red";
                            return false;
                        }
                    }
                ...
                function DistrictValidate() {
                    ...
                    if (name.value.trim() == "") {
                        ...
                        if (reg.test(name.value)) {
                            ...
                            udaydisplay.innerHTML = "Only letters are allowed in District Name";
                            udaydisplay.style.color = "red";
                            return false;
                        }
                    }
                ...
                function bt()
                {
                    ...
                    if (
                name.value === "" || Lname.value === "" || Fname.value === "" ||
                Mname.value === "" || mfirstInput.value === "" || msecondInput.value === "" ||
                efirstInput.value === "" || esecondInput.value === "" || afirstInput.value === "" ||
                asecondInput.value === "" || pfirstInput.value === "" || psecondInput.value === "" ||
                sname.value === "" || dname.value === "" || cname.value === "" || zname.value === ""
            ) {
                                ...
                                <div class="form-content">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <span
                                                    >First Name <font face="Lato" color="red">*</font></span
                                                >
                                                <input
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <span
                                                    >Last Name <font face="Lato" color="red">*</font></span
                                                >
                                                <input
                                                    onkeyup="Lvalidate()"
                                                    id="Lname"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <span
                                                    >Occupation<font face="Lato" color="red">*</font></span
                                                >
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    ...
                                                    <option value="city1">Marital 1</option>
                                                    <option value="city2">Marital 2</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <span>Gmail <font face="Lato" color="red">*</font></span>
                                                <input
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input
                                                    ...
                                                    value=""
                                                    />
                                                <span id="adisplay2" style="color: red; font-size: 14px"
                                                      >*</span
                                                >
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <span
                                                    >Pan Number <font face="Lato" color="red">*</font></span
                                                >
                                                <input
                                                    onkeyup="panvalidate()"
                                                    id="firstpan"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <span
                                                    >Address <font face="Lato" color="red">*</font></span
                                                >
                                                <input
                                                    type="text"
                                                    class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <span>State <font face="Lato" color="red">*</font></span>
                                                <input
                                                    onkeyup="StateValidate()"
                                                    id="state"
                                                    type="text"
                                                    class="form-control"
                                                    placeholder="State"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <span
                                                    >District <font face="Lato" color="red">*</font></span
                                                >
                                                <input
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <span>City <font face="Lato" color="red">*</font></span>
                                                <input
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <span>Zip <font face="Lato" color="red">*</font></span>
                                                <input
                                                    onkeyup="zipvalidate()"
                                                    id="zip"
                                                    type="text"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <span
                                                    >Fill OTP <font face="Lato" color="red">*</font></span
                                                >
                                                <input
                                                    type="text"
                                                    class="form-control"
