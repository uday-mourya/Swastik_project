...
<html>
    ...
    <body>
        <% 
        List<EmployeeInformationDao> d =EmployeeInformationDto.employeeAlldata();
            ...
            %>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p class="fw-normal mb-1"><%=p.getPosition() %></p>
                        
                       
                      </td>
                      <td>
                           <p class="fw-normal mb-1"><%=p.getDob() %></p>
                       
                      </td>
                      <td>
                           <p class="fw-normal mb-1"><%=p.getSalary() %></p>
                      </td>
                      <td>
