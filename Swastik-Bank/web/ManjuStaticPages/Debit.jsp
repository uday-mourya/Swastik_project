<%-- 
    Document   : Debit
    Created on : 28-Nov-2023, 11:38:45 pm
    Author     : abc
--%>
          ...
          <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 mt-3" >
            <div class="col">
              <div class="card  bg-LIGHT pb-2 ms-3" >
                <div class="card-body">                                      
                 ...
                 <ul >
                  <a href="" class=" nav-link text-dark">FEATURED DEBIT <br> CARDS</a>
                   <li><a href="" class=" nav-link text-dark">Gemstone Debit Cards</a></li>
                   <li><a href="" class=" nav-link text-dark" >Personal Cards
                  </a></li>
            ...
            <div class="col">
              <div class="card bg-LIGHT pb-2 ms-3">
                <div class="card-body">
                  ...
                  <ul >
                    <a href="" class=" nav-link text-dark">EXPRESSIONS DEBIT CARDS</a>
                    Now personalize your Debit Card as you like. Pick and choose from a gallery of 200+ awesome designs or choose one of your own pics and flaunt it
            ...
            <div class="col">
              <div class="card bg-LIGHT pb-2 ms-3">
                <div class="card-body">                          
                  <ul >
                      <a href="" class=" nav-link text-dark">STANDING INSTRUCTION & RECURRING CHARGES</a>
                       <li><a href="" class=" nav-link text-dark">Frequently Asked Questions</a></li>
                       <li><a href="" class=" nav-link text-dark" >Mandate Hub User Guide</a></li>
                       <li><a href="" class=" nav-link text-dark" >Frequently Asked Questions</a></li>
            ...
            <div class="col ">
              <div class="card  bg-LIGHT pb-2 mt-3 ms-3">
                <div class="card-body">                                      
                  <ul >
                    <a href="" class=" nav-link text-dark">SPECIAL OFFERS
                    </a><br>
                     <li><a href="" class=" nav-link text-dark">Special Offers</a></li>
                    <!-- <a href="">know more</a> -->
                    <li><a href="" class=" nav-link text-dark">Debit Card Rewards</a></li>
                    <a href="">know more</a>
                   </ul>
                </div>
                </div>
