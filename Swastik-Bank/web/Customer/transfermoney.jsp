                    ...
                    <tr>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <p class="fw-bold mb-1" name="beneficiaryName"> 
                                        <input type="text" value="<%= bdao.getName()%>" name="beneficiaryName" disabled>
                                    </p>
                        ...
                        <td>
                            <p class="fw-normal mb-1" >
                                <input type="text" value="<%= bdao.getBank()%>" name="beneficiaryBank" disabled>
                            </p>
                        </td>
                        ...
                        <td >
                            ...
                            <td>
                            <center>
                            <a href="transfermoney2.jsp" class="btn btn-primary">Send</a>
                            <a href="../DeleteBeneficiary" class="btn btn-danger">delete</a>
                            </center>
                        </td>
                    </tr>
                    <%
