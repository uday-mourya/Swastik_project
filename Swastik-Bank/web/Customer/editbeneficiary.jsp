                ...
                for(BeneficiaryDao bdao: beneficiaryDao){
                      if(bdao.getAccNum().equals(request.getParameter("beneficiaryAccNum"))){
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control" name="bName" value="<%= bdao.getName()%>">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="tex" class="form-control" id="inputAccNum" name="accNum" value="<%=bdao.getAccNum()%>">
                        </div>
                        <div class="col-md-6">
                            <label for="inputCAccNum" class="form-label">Confirm Account Number</label>
                            <input type="text" class="form-control" id="inputCAccNum" name="CAccNum" value="<%=bdao.getAccNum()%>">
                        </div>
                        <div class="col-md-6">
